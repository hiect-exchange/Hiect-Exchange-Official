# Public WAPI for HIECT (2018-04-01)
...
```
Fetch small amounts of assets exchanged HET records.
...
```javascript
{
    ...
    "results": {
        ...
        "rows": [
            {
                "transfered_total": "0.00132256",//Total transfered HET amount for this exchange.
